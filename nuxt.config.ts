  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: "icon", type: "image/png", sizes: "48x48", href: "/icon/favicon-48x48.png" },
        { rel: "icon", type: "image/png", sizes: "96x96", href: "/icon/globe-96x96.png" },
      ...
      meta: [
        ...
        { property: "og:image", content: "/icon/globe-512x512.png" },
